...
boxplot(Pea ~ temp, data = data.pea.MDR) # quad
boxplot(MDR ~ temp, data = data.pea.MDR) # briere


############## Trait name and parameter symbol - model type (e.g. quadratic, Briere)

############ Probability of egg to adult survival (pea) - no truncation
# Get data
...
mcmcplot(model.out)
DIC.pea.briere.noT <- model.out$BUGSoutput$DIC

# Save model output 
save(model.out, file = "saved posteriors/krijn_pea_briere_noT_uniform.Rdata")
...
model.out$BUGSoutput$summary[1:10,]
mcmcplot(model.out)
DIC.pea.briere.withT <- model.out$BUGSoutput$DIC

# Save model output 
save(model.out, file = "saved posteriors/krijn_pea_briere_withT_uniform.Rdata")
...
#############same data for krijn pea but now the quadratic no T - only save the DIC value for comparison
# Run JAGS - **select correct model file**
...
# Examine model output & run diagnostics
model.out$BUGSoutput$summary[1:10,]
DIC.pea.quad.noT <- model.out$BUGSoutput$DIC

# Save model output 
save(model.out, file = "saved posteriors/krijn_pea_quad_noT_uniform.Rdata")
...
#############same data for krijn pea but now the quadratic with Truncation - only save the DIC value for comparison
# Run JAGS - **select correct model file**
...
# Examine model output & run diagnostics
model.out$BUGSoutput$summary[1:10,]
DIC.pea.quad.withT <- model.out$BUGSoutput$DIC

# Save model output 
save(model.out, file = "saved posteriors/krijn_pea_quad_withT_uniform.Rdata")
...
model.out$BUGSoutput$summary[1:10,]
mcmcplot(model.out)
DIC.MDR.briere.noT <- model.out$BUGSoutput$DIC

# Save model output 
save(model.out, file = "saved posteriors/krijn_MDR_briere_noT_uniform.Rdata")
...
model.out$BUGSoutput$summary[1:10,]
mcmcplot(model.out)
DIC.MDR.briere.withT <- model.out$BUGSoutput$DIC

# Save model output 
save(model.out, file = "saved posteriors/krijn_MDR_briere_withT_uniform.Rdata")
...
# Examine model output & run diagnostics
model.out$BUGSoutput$summary[1:10,]
DIC.MDR.quad.noT <- model.out$BUGSoutput$DIC

# Save model output 
save(model.out, file = "saved posteriors/krijn_MDR_quad_noT_uniform.Rdata")
...
#############same data for Krijn MDR but now the quadratic with Truncation - only save the DIC value for comparison
# Run JAGS - **select correct model file**
model.out <- jags(data=jag.data, inits=inits, parameters.to.save=parameters, model.file="quad_T.txt",
                  n.thin=nt, n.chains=nc, n.burnin=nb, n.iter=ni, DIC=T, working.directory=getwd())
...
# Examine model output & run diagnostics
model.out$BUGSoutput$summary[1:10,]
DIC.MDR.quad.withT <- model.out$BUGSoutput$DIC

# Save model output 
save(model.out, file = "saved posteriors/krijn_MDR_quad_withT_uniform.Rdata")
