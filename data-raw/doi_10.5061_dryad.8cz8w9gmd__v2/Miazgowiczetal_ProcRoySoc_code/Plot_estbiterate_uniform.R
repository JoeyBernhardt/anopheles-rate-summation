...
load("saved posteriors/est.bite_briere_noT_all_uniform.Rdata")
est.bite.all.noT.preds <- model.out$BUGSoutput$sims.list$z.trait.mu.pred
load("saved posteriors/est.bite_briere_withT_all_uniform.Rdata")
est.bite.all.withT.preds <- model.out$BUGSoutput$sims.list$z.trait.mu.pred
load("saved posteriors/est.bite_briere_noT_means_uniform.Rdata")
est.bite.mean.noT.preds <- model.out$BUGSoutput$sims.list$z.trait.mu.pred
"saved posteriors/est.bite_briere_withT_means_uniform.Rdata"
est.bite.mean.withT.preds <- model.out$BUGSoutput$sims.list$z.trait.mu.pred
...
pdf("plots/est.bite_fits_raw.pdf", width = 10, height = 12)
par(mfrow=c(4,3))
trait.plots("est.bite", "est.bite_briere_noT_all_uniform.Rdata", data.no0, "Estimated biting rate")
trait.plots("est.bite", "est.bite_briere_withT_all_uniform.Rdata", data.no0, "Estimated biting rate")
trait.plots("est.bite", "est.bite_briere_noT_means_uniform.Rdata", data.block.temp, "Estimated biting rate")
trait.plots("est.bite", "est.bite_briere_withT_means_uniform.Rdata", data.block.temp, "Estimated biting rate")
par(mfrow = c(1,1))
dev.off()
##########
...
###########
pdf("plots/est.bite_fits_mean_se.pdf", width = 10, height = 12)
par(mfrow = c(4,3))
trait.plots.meanse("est.bite", "est.bite_briere_noT_all_uniform.Rdata", data.no0, "Estimated biting rate")
trait.plots.meanse("est.bite", "est.bite_briere_withT_all_uniform.Rdata", data.no0, "Estimated biting rate", cols = "purple", add = "true")
legend('topleft', legend = c("all_noT", "all_withT"), lty = 1, col = c("black", "purple"), bty = 'n')
mtext("A", side = 3, at = -5, cex = 1.8, line = 2)

trait.plots.meanse("est.bite", "est.bite_briere_noT_means_uniform.Rdata", data.block.temp, "Estimated biting rate")
trait.plots.meanse("est.bite", "est.bite_briere_withT_means_uniform.Rdata", data.block.temp, "Estimated biting rate", cols = "purple", add = "true")
legend('topleft', legend = c("means_noT", "means_withT"), lty = 1, col = c("black", "purple"), bty = 'n')
mtext("B", side = 3, at = -5, cex = 1.8, line = 2)
plot(NULL)

trait.plots.meanse("est.bite", "est.bite_briere_noT_all_uniform.Rdata", data.no0, "Estimated biting rate")
trait.plots.meanse("est.bite", "est.bite_briere_noT_means_uniform.Rdata", data.block.temp, "Estimated biting rate", cols = "royalblue", add = "true")
legend('topleft', legend = c("all_noT", "means_noT"), lty = 1, col = c("black", "royalblue"), bty = 'n')
mtext("C", side = 3, at = -5, cex = 1.8, line = 2)

trait.plots.meanse("est.bite", "est.bite_briere_withT_all_uniform.Rdata", data.no0, "Estimated biting rate")
trait.plots.meanse("est.bite", "est.bite_briere_withT_means_uniform.Rdata", data.block.temp, "Estimated biting rate", cols = "royalblue", add = "true")
legend('topleft', legend = c("all_withT", "means_withT"), lty = 1, col = c("black", "royalblue"), bty = 'n')
mtext("D", side = 3, at = -5, cex = 1.8, line = 2)
plot(NULL)

trait.plots.meanse("est.bite", "est.bite_briere_noT_all_uniform.Rdata", data.no0, "Estimated biting rate")
trait.plots.meanse("est.bite", "est.bite_briere_withT_means_uniform.Rdata", data.block.temp, "Estimated biting rate", cols = "darkcyan", add = "true")
legend('topleft', legend = c("all_noT", "means_withT"), lty = 1, col = c("black","darkcyan"), bty = 'n')
mtext("E", side = 3, at = -5, cex = 1.8, line = 2)

trait.plots.meanse("est.bite", "est.bite_briere_withT_means_uniform.Rdata", data.block.temp, "Estimated biting rate")
trait.plots.meanse("est.bite", "est.bite_briere_noT_means_uniform.Rdata", data.block.temp, "Estimated biting rate", cols = "firebrick", add = "true")
trait.plots.meanse("est.bite", "est.bite_briere_withT_all_uniform.Rdata", data.no0, "Estimated biting rate", cols = "dodgerblue", add = "true")
trait.plots.meanse("est.bite", "est.bite_briere_noT_all_uniform.Rdata", data.no0, "Estimated biting rate", cols = "darkgreen", add = "true")
