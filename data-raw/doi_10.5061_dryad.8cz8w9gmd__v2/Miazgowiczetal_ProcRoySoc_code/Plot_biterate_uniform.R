...
load("saved posteriors/bite.rate_briere_noT_all_uniform.Rdata")
bite.rate.all.noT.preds <- model.out$BUGSoutput$sims.list$z.trait.mu.pred
load("saved posteriors/bite.rate_briere_withT_all_uniform.Rdata")
bite.rate.all.withT.preds <- model.out$BUGSoutput$sims.list$z.trait.mu.pred
load("saved posteriors/bite.rate_briere_noT_means_uniform.Rdata")
bite.rate.mean.noT.preds <- model.out$BUGSoutput$sims.list$z.trait.mu.pred
"saved posteriors/bite.rate_briere_withT_means_uniform.Rdata"
bite.rate.mean.withT.preds <- model.out$BUGSoutput$sims.list$z.trait.mu.pred
...
pdf("plots/biterate_fits_raw.pdf", width = 10, height = 12)
par(mfrow=c(4,3))
trait.plots("bite.rate", "bite.rate_briere_noT_all_uniform.Rdata", data.all, "Biting rate")
trait.plots("bite.rate", "bite.rate_briere_withT_all_uniform.Rdata", data.all, "Biting rate")
trait.plots("bite.rate", "bite.rate_briere_noT_means_uniform.Rdata", data.block.temp, "Biting rate")
trait.plots("bite.rate", "bite.rate_briere_withT_means_uniform.Rdata", data.block.temp, "Biting rate")
par(mfrow = c(1,1))
dev.off()
##########
...
###########
pdf("plots/biterate_fits_mean_se.pdf", width = 10, height = 12)
par(mfrow = c(4,3))
trait.plots.meanse("bite.rate", "bite.rate_briere_noT_all_uniform.Rdata", data.all, "Biting rate")
trait.plots.meanse("bite.rate", "bite.rate_briere_withT_all_uniform.Rdata", data.all, "Biting rate", cols = "purple", add = "true")
legend('topleft', legend = c("all_noT", "all_withT"), lty = 1, col = c("black", "purple"), bty = 'n')
mtext("A", side = 3, at = -5, cex = 1.8, line = 2)

trait.plots.meanse("bite.rate", "bite.rate_briere_noT_means_uniform.Rdata", data.block.temp, "Biting rate")
trait.plots.meanse("bite.rate", "bite.rate_briere_withT_means_uniform.Rdata", data.block.temp, "Biting rate", cols = "purple", add = "true")
legend('topleft', legend = c("means_noT", "means_withT"), lty = 1, col = c("black", "purple"), bty = 'n')
mtext("B", side = 3, at = -5, cex = 1.8, line = 2)
plot(NULL)

trait.plots.meanse("bite.rate", "bite.rate_briere_noT_all_uniform.Rdata", data.all, "Biting rate")
trait.plots.meanse("bite.rate", "bite.rate_briere_noT_means_uniform.Rdata", data.block.temp, "Biting rate", cols = "royalblue", add = "true")
legend('topleft', legend = c("all_noT", "means_noT"), lty = 1, col = c("black", "royalblue"), bty = 'n')
mtext("C", side = 3, at = -5, cex = 1.8, line = 2)

trait.plots.meanse("bite.rate", "bite.rate_briere_withT_all_uniform.Rdata", data.all, "Biting rate")
trait.plots.meanse("bite.rate", "bite.rate_briere_withT_means_uniform.Rdata", data.block.temp, "Biting rate", cols = "royalblue", add = "true")
legend('topleft', legend = c("all_withT", "means_withT"), lty = 1, col = c("black", "royalblue"), bty = 'n')
mtext("D", side = 3, at = -5, cex = 1.8, line = 2)
plot(NULL)

trait.plots.meanse("bite.rate", "bite.rate_briere_noT_all_uniform.Rdata", data.all, "Biting rate")
trait.plots.meanse("bite.rate", "bite.rate_briere_withT_means_uniform.Rdata", data.block.temp, "Biting rate", cols = "darkcyan", add = "true")
legend('topleft', legend = c("all_noT", "means_withT"), lty = 1, col = c("black","darkcyan"), bty = 'n')
mtext("E", side = 3, at = -5, cex = 1.8, line = 2)

trait.plots.meanse("bite.rate", "bite.rate_briere_withT_means_uniform.Rdata", data.block.temp, "Biting rate")
trait.plots.meanse("bite.rate", "bite.rate_briere_noT_means_uniform.Rdata", data.block.temp, "Biting rate", cols = "firebrick", add = "true")
trait.plots.meanse("bite.rate", "bite.rate_briere_withT_all_uniform.Rdata", data.all, "Biting rate", cols = "dodgerblue", add = "true")
trait.plots.meanse("bite.rate", "bite.rate_briere_noT_all_uniform.Rdata", data.all, "Biting rate", cols = "darkgreen", add = "true")
