...
write.csv(temp16DTR12_B1_KM_values, "data-processed/temp16DTR12_B1_KM_values.csv", row.names = FALSE)
...
write.csv(temp16DTR12_B2_KM_values, "data-processed/temp16DTR12_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp20DTR12_B1_KM_values, "data-processed/temp20DTR12_B1_KM_values.csv", row.names = FALSE)
...
write.csv(temp20DTR12_B2_KM_values, "data-processed/temp20DTR12_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp24DTR12_B1_KM_values, "data-processed/temp24DTR12_B1_KM_values.csv", row.names = FALSE)
...
write.csv(temp24DTR12_B2_KM_values, "data-processed/temp24DTR12_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp28DTR12_B1_KM_values, "data-processed/temp28DTR12_B1_KM_values.csv", row.names = FALSE)
...
write.csv(temp28DTR12_B2_KM_values, "data-processed/temp28DTR12_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp32DTR12_B1_KM_values, "data-processed/temp32DTR12_B1_KM_values.csv", row.names = FALSE)
...
write.csv(temp32DTR12_B2_KM_values, "data-processed/temp32DTR12_B2_KM_values.csv", row.names = FALSE)
...
#Export this for use in excel
write.csv(life.expect.dtr12, "data-processed/lifeexpectDTR12.replicate.ave.fromGOMPZ.csv")
...
write.csv(temp16DTR0_B2_KM_values, "data-processed/temp16DTR0_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp16DTR0_B3_KM_values, "data-processed/temp16DTR0_B3_KM_values.csv", row.names = FALSE)
...
write.csv(temp20DTR0_B2_KM_values, "data-processed/temp20DTR0_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp20DTR0_B3_KM_values, "data-processed/temp20DTR0_B3_KM_values.csv", row.names = FALSE)
...
write.csv(temp24DTR0_B2_KM_values, "data-processed/temp24DTR0_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp24DTR0_B3_KM_values, "data-processed/temp24DTR0_B3_KM_values.csv", row.names = FALSE)
...
write.csv(temp28DTR0_B2_KM_values, "data-processed/temp28DTR0_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp28DTR0_B3_KM_values, "data-processed/temp28DTR0_B3_KM_values.csv", row.names = FALSE)
...
write.csv(temp28DTR0_B4_KM_values, "data-processed/temp28DTR0_B4_KM_values.csv", row.names = FALSE)
...
write.csv(temp32DTR0_B2_KM_values, "data-processed/temp32DTR0_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp32DTR0_B5_KM_values, "data-processed/temp32DTR0_B5_KM_values.csv", row.names = FALSE)
...
write.csv(temp36DTR0_B2_KM_values, "data-processed/temp36DTR0_B2_KM_values.csv", row.names = FALSE)
...
write.csv(temp36DTR0_B5_KM_values, "data-processed/temp36DTR0_B5_KM_values.csv", row.names = FALSE)
