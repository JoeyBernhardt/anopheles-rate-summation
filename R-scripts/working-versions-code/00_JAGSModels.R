...
## Script with JAGS models for fitting TPCs
...
#   	trait across atemperature gradient for each saved sample in the MCMC chain. This output 
#   	is what we use later on to calculate R0. 



################### Truncated normally-distributed Briere - for individual biting rate data
...
################### Negative Binomial-distributed Quadtratic - for individual lifetime eggs data
...
############## Normally-distributed Quadratic - for group mean data
...
############## Normally-distributed Quadratic - for group mean data - derived quantities always =< 1 (for traits that are proportions)
...
############## Normally-distributed Briere - for group mean data
