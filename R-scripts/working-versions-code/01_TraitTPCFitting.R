...
## Script for fitting trait TPCs using JAGS
...
##### Run JAGS - **select correct model file**
model_lifespan_constant_negpred <- jags(data=jag.data, inits=inits, parameters.to.save=parameters, model.file="quad_gamma_negpred.txt",
								n.thin=nt, n.chains=nc, n.burnin=nb, n.iter=ni, DIC=T, working.directory=getwd())
...
boxplot(data_mdr$trait ~ data_mdr$T)
