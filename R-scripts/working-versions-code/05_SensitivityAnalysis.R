...
## Written by Marta Shocket in 2023
## Based on code originally written by Marta Shocket in 2018
...
##  3. Calculate trait means across temperature gradient
##  4. Sensitivity analysis #1 - partial derivatives
...
legend(x = 13.5, y = 1.025, col = c("black"), lwd = 3, lty = 1, legend = c("Lifetime model"), bty = "n", cex = 1)
...
legend(x = 11.5, y = 1.025, col = c("black"), lwd = 3, lty = 1, legend = c("Lifetime model"), bty = "n", cex = 1)
...
legend(x = 7, y = 1.025, col = c("black"), lwd = 3, lty = 1, legend = c("Lifetime model"), bty = "n", cex = 1)
