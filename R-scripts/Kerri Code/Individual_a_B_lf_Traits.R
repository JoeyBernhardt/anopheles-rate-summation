...
##                  i. 'constant.individual.trait'
##                  ii. 'fluc9.individual.trait'
##                  iii. 'fluc12.individual.trait'
##        
...
#             Note:Female is a unique int within each dataset but not across datasets
###
######################
...
write.csv(constant.individual.trait, "data/constant.individual.trait.csv")
write.csv(fluc9.individual.trait, "data/fluc9.individual.trait.csv")
write.csv(fluc12.individual.trait, "data/fluc12.individual.trait.csv")
